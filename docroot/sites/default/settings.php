...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'www_drupalcampmumbai_dev',
      'username' => 'root',
      'password' => '',
      'host' => '127.0.0.1',
      'port' => '',
 ...
 *
 */
$drupal_hash_salt = 'NuXvN91WuOYXZStLqASrIOsVG7QpGkAfL6I30MjLGJs';
...
# Acquia Environment Requirement
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/dcmumbai/dcmumbai-settings.inc');
}