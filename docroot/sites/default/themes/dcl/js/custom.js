(function ($) {
  Drupal.behaviors.theming = {
    attach: function (context, settings) {
      ...
      var priMenu = $('#header-top-inner #block-menu-menu-header-top');
      var priSubMenu = $('#header-top-inner #block-menu-menu-header-top ul li.expanded ul');
      priSubMenu.hide();
      ...
      // secondary menu
      var secMenu = $('#header-top-inner #secondary-menu');
      secMenu.hide();
      ...
      $('<h2>Sponsors</h2>').insertBefore('.front .region-preface-top');
